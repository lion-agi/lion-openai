...
class Hyperparameters(BaseModel):
    ...
    batch_size: Union[Literal["auto"], int] = Field(None, description="The batch size.")

    learning_rate_multiplier: Union[Literal["auto"], int] = Field(
...
class Wandb(BaseModel):
    ...
    tags: Optional[List[str]] = Field(description="A list of tags for the run.")


class Integration(BaseModel):
    type: str = Field(..., description="The type of the integration being enabled.")

    wandb: Optional[Wandb] = Field(
