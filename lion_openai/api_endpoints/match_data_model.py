def match_data_model(task_name):
    if task_name == "create_speech":
        ...
        from lion_openai.api_endpoints.embeddings.request_body import (
            OpenAIEmbeddingRequestBody,
        )

        return {"request_body": OpenAIEmbeddingRequestBody}
    elif task_name == "create_fine_tuning_job":
        from lion_openai.api_endpoints.fine_tuning.create_jobs import (
        ...
        from lion_openai.api_endpoints.fine_tuning.list_fine_tuning_jobs import (
            OpenAIListFineTuningJobsQueryParam,
        )

        return {"params": OpenAIListFineTuningJobsQueryParam}
    elif task_name == "list_fine_tuning_events":
        from lion_openai.api_endpoints.fine_tuning.list_fine_tuning_events import (
        ...
        from lion_openai.api_endpoints.fine_tuning.list_fine_tuning_checkpoints import (
        ...
        from lion_openai.api_endpoints.fine_tuning.retrieve_jobs import (
        ...
        from lion_openai.api_endpoints.fine_tuning.cancel_jobs import (
        ...
        from lion_openai.api_endpoints.batch.retrieve_batch import (
            OpenAIRetrieveBatchPathParam,
        )

        return {"path_param": OpenAIRetrieveBatchPathParam}
    elif task_name == "cancel_batch":
        from lion_openai.api_endpoints.batch.cancel_batch import (
        ...
        from lion_openai.api_endpoints.files.upload_file import (
        ...
        from lion_openai.api_endpoints.uploads.complete_upload import (
        ...
        from lion_openai.api_endpoints.uploads.cancel_upload import (
        ...
        from lion_openai.api_endpoints.images.image_edit_models import (
            OpenAIImageEditRequestBody,
        )

        return {"form_data": OpenAIImageEditRequestBody}
    elif task_name == "create_image_variation":
        from lion_openai.api_endpoints.images.image_variation_models import (
